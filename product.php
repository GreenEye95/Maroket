...
<body>
	<div class="messagepop pop">
		    <form method="post" id="new_message" action="/messages">
		        ...
		        <p><label for="body">Password</label><input type="Password" name="body" id="body" ></p>
		        <p><input type="submit" value="Login" name="commit" id="message_submit"/> or <a href="register.php">Register here</a></p>
		    </form>
    </div>
	<div class="navbar">
  	...
  	<div class="ProductImg"><img src="img//product//pro1.png"></div>
  	<div class="ProductDescription">
  		<div class="description">
  		<h1>Bluetooth Speakers </h1>
  		<div class="price"><h3>100.00 $</h3></div>
  		<div class="specs">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud 						exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla 						pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.

							Pri quas audiam virtute ut, case utamur fuisset eam ut, iisque accommodare an eam. Reque blandit qui eu, cu vix nonumy volumus. Legendos intellegam id usu, vide oporteat vix eu, id illud principes has. Nam tempor utamur gubergren no. </div>
  		<div><a  href="" class="cart">Add to cart</a> </div>
  		<div><a href="http://facebook.com" class="buy">Buy Now</a></div>
		</div>
  	</div>
  	<div class="footer">
			<div class="aboutUs">
